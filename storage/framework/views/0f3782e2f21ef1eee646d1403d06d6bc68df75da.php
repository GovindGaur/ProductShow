...
<head>
    ...
    <link rel="stylesheet" href="<?php echo e(Module::asset('SellerShow:plugins/fontawesome-free/css/all.min.css')); ?>">
    <!-- Theme style -->
    <!-- <link rel="stylesheet" href="http://localhost/product_show/Modules/SellerShow/Resources/assets/css/adminlte.css"> -->

    <link rel="stylesheet" href="<?php echo e(Module::asset('SellerShow:css/adminlte.css')); ?>">
...
<body class="hold-transition sidebar-mini">
    <div class="wrapper">
            ...
            <div class="sidebar">
                ...
                <div class="user-panel mt-3 pb-3 mb-3 d-flex">
                    <div class="image">
                        ...
                        <img src="<?php echo e(Module::asset('SellerShow:img/user2-160x160.jpg')); ?>"
                            class="img-circle elevation-2" alt="User Image">
                    </div>
                    <?php if(Session()->has('seller')): ?>
                    <div class="info">
                        <a href="#" class="d-block"> <?php echo e(Session::get('seller')['name']); ?></a>
                    </div>
                    <?php endif; ?>
                </div>
        ...
        <script src="<?php echo e(Module::asset('SellerShow:plugins/jquery/jquery.min.js')); ?>">
        </script>
        <!-- Bootstrap 4 -->
        <!-- <script
            src="http://localhost/product_show/Modules/SellerShow/Resources/assets/plugins/bootstrap/js/bootstrap.bundle.min.js">
        </script> -->
        <script src="<?php echo e(Module::asset('SellerShow:plugins/bootstrap/js/bootstrap.bundle.min.js')); ?>">
        </script>
        <!-- AdminLTE App -->
