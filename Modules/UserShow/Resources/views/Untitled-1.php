...
<style>
.div_backgrndimg {
    background-image: url("{{ URL::to('/') }}/images/gotocart.jpg");
                ...
                <div class="box">
                    ...
                    <span id="{{$UserItem->id}}">
                        ...
                        <div class="div_backgrndimg">
                            <a href="CartList" id="CartList" class="gotocart">Go To Cart</a>
                        </div>
...
$(document).ready(function() {
    ...
    if (productStoreArr && productStoreArr.length) {
        productStoreArr.map((storeVal) => {
            ...
            {
                $('#product_store_' + storeVal).html(
                    "<a  href='/CartList'>Go to cart</a>")
            }
            let UserId = $('#user_id').val();
            if (UserId != undefined) {
                $.ajax({
    ...
    if (UserId != undefined) {
        $.ajax({
            ...
            success: function(data) {
                // return true;
                $('#' + ProductId).html(
                    "<div class='div_backgrndimg'><a href='/CartList' class='gotocart'>Go to cart</a> </div>"
                )
                console.log(data);
            }
        });
