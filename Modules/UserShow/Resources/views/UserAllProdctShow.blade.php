        ...
        <div class="row">
            ...
            <div class="col-sm-6 col-xl-3">
                <div class="box">
                    <a href="">
                        <div class="img-box">
                            <img src="http://localhost/product_show/storage/app/public/SellerProductImages/{{$UserItem->product_image}}"
                                alt="">
                        </div>
                        ...
                        <a href="/initiate?p={{$UserItem->product_price}}"><button class="btn btn-success" style="
    margin-left: 82px;
">Buy
                            </button></a>
                        <!-- <div class="new">
